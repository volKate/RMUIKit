...
extension ProfileViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .highlights:
            ...
            cell.configure(withHighlights: dataProvider.highlights, delegate: self)
            return cell
...
extension ProfileViewController: AccountInfoCellDelegate {
    func profileLinkTapped(link: String) {
        ...
        present(profileLinkViewController, animated: true)
    }
}
...
extension ProfileViewController: StoryViewDelegate {
    func viewStory(_ story: Story) {
        ...
        present(storyViewerViewController, animated: true)
    }
}
